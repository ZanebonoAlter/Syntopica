# article-tag-watch-toggle

## Purpose

Enable users to see the watch status of tags on the article detail page and toggle watching/unwatching directly from the article view, without navigating to the sidebar or topics page.
